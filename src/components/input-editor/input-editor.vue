<template>
  ...
  >
    <text
      class="editor-icon dicon dicon-maikefeng"
      @click="toggleKeyboardAndMic"
    />
    ...
    ></uv-textarea>
    <text class="editor-icon dicon dicon-biaoqing_3" />
    <text v-show="!inputValue" class="editor-icon dicon dicon-jia" />
